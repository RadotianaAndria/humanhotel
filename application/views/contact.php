...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
      ...
      <a class="navbar-brand" href="<?php echo base_url('Welcome/index'); ?>"><img src="<?php echo base_url() ?>assets/image/logo.png" style="width:100px; height: 95px;"></a>
          ...
          <li class="nav-item"><a href="<?php echo base_url('Welcome/index'); ?>" class="nav-link">Accueil</a></li>
	          <li class="nav-item active"><a href="<?php echo base_url('Welcome/rooms'); ?>" class="nav-link">Nos chambres</a></li>
    ...
    <div class="hero-wrap" style="background-image: url('<?php echo base_url() ?>assets/images/image_7.jpg');">
      <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text d-flex align-itemd-end justify-content-center">
          <div class="col-md-9 ftco-animate text-center d-flex align-items-end justify-content-center">
          	<div class="text">
	            <p class="breadcrumbs mb-2"><span class="mr-2"><a href="<?php echo base_url('Welcome/index'); ?>">Home</a></span> <span>Contact</span></p>
	            <h1 class="mb-4 bread">Contacter nous</h1>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row d-flex mb-5 contact-info">
          ...
          <div class="col-md-4 d-flex">
          	<div class="info bg-white p-4">
	            <p><span>Addresse:</span> Lot k6 042 Ivato, 105 Antananarivo, Madagascar </p>
	          </div>
          </div>
          <div class="col-md-4 d-flex">
          	<div class="info bg-white p-4">
	            <p><span>Téléphone:</span> <a href="#">+261323247896</a></p>
	          </div>
          </div>
          <div class="col-md-4 d-flex">
          	<div class="info bg-white p-4">
	            <p><span>Email:</span> <a href="mailto:info@yoursite.com">contact@humanhotel-mg.com</a></p>
	          </div>
          </div>
        </div>
